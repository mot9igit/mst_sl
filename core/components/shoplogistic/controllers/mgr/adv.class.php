...
class ShoplogisticMgrADVManagerController extends slManagerController
{
    /**
     * @return string
     */
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/adv/pages/grid.js?v='.$this->shopLogistic->config['version']);
        ...
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/adv/adv.js?v='.$this->shopLogistic->config['version']);
        ...
        $this->addHtml('<script type="text/javascript">
			...
			Ext.onReady(function() {MODx.load({ xtype: "shoplogistic-page-adv"});});
        </script>');
