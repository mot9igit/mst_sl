...
class ShoplogisticMgrDocsManagerController extends slManagerController
{
    /**
     * @return string
     */
    ...
    {
        return $this->modx->lexicon('shoplogistic_docs') . ' | shoplogistic';
    }
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/filedocs/filedocs.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/filedocs/panel.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/filedocs/grid.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/filedocs/windows.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/filedocs/status.grid.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/filedocs/status.windows.js?v='.$this->shopLogistic->config['version']);
        ...
        $this->addHtml('<script type="text/javascript">
			...
			Ext.onReady(function() {MODx.load({ xtype: "shoplogistic-page-filedocs"});});
        </script>');
