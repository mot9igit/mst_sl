...
class ShoplogisticMgrCardRequestManagerController extends slManagerController
{
    /**
     * @return string
     */
    ...
    {
        return $this->modx->lexicon('shoplogistic_card_request') . ' | shoplogistic';
    }
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/card_request/card_request.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/card_request/panel.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/card_request/grid.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/card_request/windows.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/card_request/status.grid.js?v='.$this->shopLogistic->config['version']);
        $this->addJavascript($this->shopLogistic->config['jsUrl'] . 'mgr/card_request/status.windows.js?v='.$this->shopLogistic->config['version']);
        ...
        $this->addHtml('<script type="text/javascript">
			...
			Ext.onReady(function() {MODx.load({ xtype: "shoplogistic-page-card-request"});});
        </script>');
