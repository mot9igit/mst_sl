...
class slStoresRemainsStatusUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('shoplogistic_store_remains_status_err_ns');
        }
...
return 'slStoresRemainsStatusUpdateProcessor';
