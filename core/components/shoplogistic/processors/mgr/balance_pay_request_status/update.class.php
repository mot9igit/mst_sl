...
class slStoreBalancePayRequestStatusUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('shoplogistic_balance_pay_request_status_err_ns');
        }
...
return 'slStoreBalancePayRequestStatusUpdateProcessor';
