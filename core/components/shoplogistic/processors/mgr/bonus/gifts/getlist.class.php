    ...
    public function prepareRow(xPDOObject $object)
    {
        ...
        if (!$array['active']) {
            $array['actions'][] = [
                ...
                'title' => $this->modx->lexicon('shoplogistic_gift_enable'),
                'multiple' => $this->modx->lexicon('shoplogistic_gift_enable'),
                'action' => 'enableGift',
                'button' => true,
                'menu' => true,
            ];
            ...
            $array['actions'][] = [
                ...
                'title' => $this->modx->lexicon('shoplogistic_gift_disable'),
                'multiple' => $this->modx->lexicon('shoplogistic_gift_disable'),
                'action' => 'disableGift',
                'button' => true,
                'menu' => true,
            ];
