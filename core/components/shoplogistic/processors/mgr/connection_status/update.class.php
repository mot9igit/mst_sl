...
class slBonusesConnectionStatusUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('shoplogistic_connection_status_err_ns');
        }
...
return 'slBonusesConnectionStatusUpdateProcessor';
