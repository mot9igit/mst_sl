...
class slCardRequestGetListProcessor extends modObjectGetListProcessor
{
    ...
    {
        $c->leftJoin('slCardRequestStatus', 'Status');
        ...
        $c->select(
            $this->modx->getSelectColumns('slCardRequest', 'slCardRequest', '', array(), true) . ',
...
return 'slCardRequestGetListProcessor';