...
class slRequestb2bDisableProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($ids as $id) {
            ...
            $statuses = $this->modx->getObject("slActionsStatus", array("name" => "Отказ"));
...
return 'slRequestb2bDisableProcessor';
