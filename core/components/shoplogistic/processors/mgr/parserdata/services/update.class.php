...
class slParserDataServiceUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('shoplogistic_parserdata_services_err_ns');
        }
...
return 'slParserDataServiceUpdateProcessor';
