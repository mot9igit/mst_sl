...
class slParserDataTasksUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('shoplogistic_parserdata_tasks_err_ns');
        }
...
return 'slParserDataTasksUpdateProcessor';
