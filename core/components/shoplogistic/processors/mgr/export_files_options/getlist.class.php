...
class slExportFilesCatsOptionsGetListProcessor extends modObjectGetListProcessor
{
    ...
    public function prepareQueryBeforeCount(xPDOQuery $c)
    {
        ...
        $c->leftJoin('msOption', 'msOption', '`msOption`.`id` = `slExportFilesCatsOptions`.`option_id`');

        $c->select(
            $this->modx->getSelectColumns('slExportFilesCatsOptions', 'slExportFilesCatsOptions', '', array(), true) . ',
...
return 'slExportFilesCatsOptionsGetListProcessor';