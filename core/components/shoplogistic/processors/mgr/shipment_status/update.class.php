...
class slWarehouseShipmentStatusUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('shoplogistic_shipment_status_err_ns');
        }
...
return 'slWarehouseShipmentStatusUpdateProcessor';
