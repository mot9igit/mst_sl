...
Ext.extend(shopLogistic.grid.APIRequest, shopLogistic.grid.Default, {
    ...
    getFields: function () {
        return ['id', 'method', 'api_key','store_id', 'ip', 'file', 'store_name', 'createdon', 'request', 'request_content', 'response', 'response_content', 'status', 'status_name', 'color', 'description', 'actions'];
    },
    ...
    getColumns: function () {
        return [
            ...
            {
                header: _('shoplogistic_apirequest_api_key'),
                dataIndex: 'api_key',
                sortable: true,
                width: 100,
            },
            {
                header: _('shoplogistic_apirequest_store_id'),
