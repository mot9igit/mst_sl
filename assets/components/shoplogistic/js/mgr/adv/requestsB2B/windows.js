shopLogistic.window.CreateRequestsB2B = function (config) {
    config = config || {};

    Ext.applyIf(config, {
        title: _('shoplogistic_requestB2B_create'),
        width: 600,
        baseParams: {
            action: 'mgr/adv/requestsB2B/create',
        },
    });
    shopLogistic.window.CreateRequestsB2B.superclass.constructor.call(this, config);
};
Ext.extend(shopLogistic.window.CreateRequestsB2B, shopLogistic.window.Default, {
...
Ext.reg('shoplogistic-window-requestB2B-create', shopLogistic.window.CreateRequestsB2B);


shopLogistic.window.UpdateRequestsB2B = function (config) {
    config = config || {};

    Ext.applyIf(config, {
        title: _('shoplogistic_request_update'),
        baseParams: {
            action: 'mgr/adv/requestsB2B/update',
        },
        bodyCssClass: 'tabs',
    });
    shopLogistic.window.UpdateRequestsB2B.superclass.constructor.call(this, config);
};
Ext.extend(shopLogistic.window.UpdateRequestsB2B, shopLogistic.window.CreateRequestsB2B, {

    getFields: function (config) {
        return shopLogistic.window.CreateRequestsB2B.prototype.getFields.call(this, config);
    }

});
Ext.reg('shoplogistic-window-requestB2B-update', shopLogistic.window.UpdateRequestsB2B);